...
class AboutDriverRanking extends \core\HtmlContent {
    ...
    public function getHtml() {
        ...
        $t = "The ACswui system does integrate a driver ranking system.
    ...
    private function rankingPoints() {
        ...
        $t = "The driver ranking system applies points for experience, success and safety of drivers.
        ...
        $t = "By leading positions in race, qualifying and record tables, a driver can gain success points.\n
        ...
        $t = "To restrict rough driving and encourage fair driving the ranking system counts points for unsave driving maneuvers.
    ...
    private function rankingPeriod() {
        ...
        $t = "The ranking points are not calculated over all sessions. Instead they are cumulated over a period of time.
    ...
    private function rankingGroups() {
        ...
        $t = "The driver ranking table is split into several groups.
        ...
        switch (\Core\ACswui::getParam("DriverRankingGroupType")) {
            case 'points':
                $t = "The group assignment of each driver is defined by reaching an absolute amount of points.";
                break;
            case 'drivers':
                $t = "Each group contains a certain amount of drivers.
                ...
                break;
            case 'percent':
                $t = "The group assignment of each driver is defined by amount of points relative to the driver with the most.";
                break;
            default:
        ...
        $t = "The minimum requirement for each group can be viewed in the driver ranking.";
        $html .= nl2br(htmlentities($t));
