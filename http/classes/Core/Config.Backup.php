...
class Config {
    ...
    // paths
    const AbsPathData = "/home/gamesrv/acswui_data";
    const RelPathData = "../../../acswui_data";
    const AbsPathHtdata = "/home/gamesrv/public_html/acswui_htdata";
    const RelPathHtdata = "../../acswui_htdata";
    const AbsPathAcswui = "/home/gamesrv/public_html/acswui";

    // basic constants
    const DefaultTemplate = "acswui";
    const LogWarning = TRUE;
    const LogDebug = TRUE;
    const RootPassword = '$2y$10$grK.Ymd75KH2TePG2EwWyeY57L.hbQNjptLeeu/lLkEJdEbqOoICe';
    const GuestGroup = 'Visitor';
    const Locales = ['de_DE'];

    // database constants
    const DbHost = "localhost";
    const DbDatabase = "acswui";
    const DbPort = "3306";
    const DbUser = "acswui";
    const DbPasswd = "gXDo8y5YZTKEEF2a";
